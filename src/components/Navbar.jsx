    ...
    <div>
      ...
      user ?
       <div className="flex itmes-center gap-2 sm:gap-3">
        <button onClick={()=> navigate("/buy")} className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105  transition-all duration-7000 '>
      ...
      <div className="relative group ">
       ...
       <div className="flex items-center sm:gap-5">
        ...
        className='bg-blue-400 rounded-full text-white px-7 py-2  sm:px-10 text-sm cursor-pointer'>Login</button>
       </div>
      }
