...
function Result() {
  ...
  return (
    ...
    className='flex flex-col min-h-[90vh] justify-center items-center' action="">
  <div>
  ...
  <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full '>
    ...
    <button type='submit' className='bg-zinc-900 px-10 sm:px-16 py-3 rounded-full placeholde-color'>Generate</button>
  </div>
}
{isImageLoaded && 
